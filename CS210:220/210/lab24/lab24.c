...
int main() {
     ...
     */
    int* nums = malloc(INIT_SIZE * sizeof(int));
     ...
     */
    int timesDoubled = fillArray(nums, INIT_SIZE, dataSetSize);
    printf("The array doubled %d times with a data set size of %d, and an initial size of %d\n\n", timesDoubled, dataSetSize, INIT_SIZE);
