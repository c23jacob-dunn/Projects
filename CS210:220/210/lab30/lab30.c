...
int main(void) {
    ...
    printf("When num_bunnies/2 == 0 -> return 3 + count_ears2(num_bunnies - 1);\n");
    printf("Otherwise num_bunnies/2 != 0 -> return 2 + count_ears2(num_bunnies - 1);\n");
...
int count_ears(int num_bunnies) {
    ...
    return (int) 2 + count_ears(num_bunnies - 1);
}
